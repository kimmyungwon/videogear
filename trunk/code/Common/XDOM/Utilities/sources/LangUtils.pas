...
{$ELSE}
  cUnicodeCodecsWin32,
{$ENDIF}
  WideStringUtils, AbnfUtils, SysUtils, Classes;
      ...
      try
        ...
        try
          for I := Ord(Low(TIso639LanguageCode)) to
            ...
            AddObject(UTF16ToEncoding(TUSASCIICodec,
              CodeToName(TIso639LanguageCode(I))), {$IFDEF CLR}TObject(I){$ELSE}Pointer(I){$ENDIF});
        except
          Clear;
          raise;
        end;
