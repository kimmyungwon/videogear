...
// d.k. There are similar bugs in UCS4CharToUTF16BE and UCS4CharToUTF16LE:
//      The transformation between UCS4 and UTF-16 should be allowed for all
//      codepoints exept from the surrogate area.
...
begin
  P := Dest;
  Case Ch of
  //  $00000080..$0000D7FF, $0000E000..$0000FFFD :    old d.k.
  $00000000..$0000D7FF, $0000E000..$0000FFFF :     // new d.k.
    begin
      SeqSize := 2;
      if not Assigned(P) or (DestSize <= 0) then
        exit;
  ...
  //  $0000D800..$0000DFFF, $0000FFFE,$0000FFFF :    old d.k.
  $0000D800..$0000DFFF :                          // new d.k.
