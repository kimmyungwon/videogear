...
//
// The Original Code is "DK.Xdom_4_1.AddOns.Tanscoder.pas".
//
...
// are Copyright (C) 2004-2007 Dieter Köhler. All Rights Reserved.
//
...
unit DK.Xdom_4_1.AddOns.Tanscoder;

interface

uses
  DK.Xdom_4_1.XdomCore, DK.Utilities.cUnicodeCodecsRTL, DK.Utilities.ParserUtilsRTL,
  {$IFDEF MSWINDOWS}
    {$IFDEF VER140+} Types,
    {$ELSE} Windows, {$ENDIF}
  {$ENDIF}
...
uses
  DK.Utilities.UnicodeUtils, DK.Utilities.WideStringUtils;
