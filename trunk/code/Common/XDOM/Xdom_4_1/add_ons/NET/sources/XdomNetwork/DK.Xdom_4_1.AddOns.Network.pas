...
//
// The Original Code is "DK.Xdom_4_1.AddOns.Network.pas".
//
...
unit DK.Xdom_4_1.AddOns.Network;
...
uses
  ...
  DK.Xdom_4_1.XdomCore, DK.Utilities.UriUtils, DK.Utilities.WideStringUtils,
  Classes, SysUtils;
...
procedure Register;
begin
  RegisterComponents('XDOM 3.2 Add-Ons',[ TIndyResourceResolver ]);
end;
