...
//
// The Original Code is "DK.Xdom.AddOns.ErrorReporting.pas".
//
...
// are Copyright (C) 1999-2007 Dieter Köhler. All Rights Reserved.
//
...
unit DK.Xdom_4_1.AddOns.ErrorReporting;

interface

uses
  DK.Xdom_4_1.XdomCore, DK.Utilities.LangUtils, DK.Utilities.AutoListUtils,
  {$IFDEF CLR}DK.Utilities.cUnicodeCodecsRTL{$ELSE}DK.Utilities.cUnicodeCodecs{$ENDIF},
  SysUtils, Classes;
