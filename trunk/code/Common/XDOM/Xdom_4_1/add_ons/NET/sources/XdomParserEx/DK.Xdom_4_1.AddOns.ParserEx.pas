...
//
// The Original Code is "DK.Xdom_4_1.AddOns.ParserEx.pas".
//
...
// are Copyright (C) 2006-2007 Dieter Köhler. All Rights Reserved.
//
...
unit DK.Xdom_4_1.AddOns.ParserEx;

interface

uses
  DK.Xdom_4_1.XdomCore, DK.Utilities.cUnicodeCodecsRTL, DK.Utilities.WideStringUtils,
  Classes, SysUtils;
...
procedure Register;
begin
  RegisterComponents('XDOM 4.1 Add-Ons',[ TXmlToDomParserEx ]);
end;
