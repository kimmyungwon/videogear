...
Delphi 5, 6, 7, 8, 2005, 2006, 2007 and Kylix 3.  It might 
also work with later Delphi or earlier Kylix versions, but 
...
* packages
  A folder containing package files to install XDOM.
  
* sources
  A folder containing the XDOM code files.